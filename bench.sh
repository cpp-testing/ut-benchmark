...
#function compile {
  #for ((v=0; v<100; ++v)); do
    #g++ -c -I. -std=c++2a test_suite_$v.cpp
  #done
...
#function compile {
  ...
  #done
  #clang++ -c -I. -std=c++2a -stdlib=libc++ $SUT/main.cpp --gcc-toolchain=/lib/gcc9/9.2.0
  #clang++ -I. -std=c++2a -stdlib=libc++ *.o --gcc-toolchain=/lib/gcc9/9.2.0
#}
function compile {
  for ((v=0; v<100; ++v)); do
    g++ -c -Igtest/googletest/googletest/include -std=c++2a test_suite_$v.cpp
  done
  g++ -c -Igtest/googletest/googletest/include -std=c++2a $SUT/main.cpp
  g++ -Igtest/googletest/googletest/include -std=c++2a *.o gtest/googletest/build/lib/libgtest.a -lpthread
}


#function compile {
  #for ((v=0; v<1; ++v)); do
    #clang++ -c -Igtest/googletest/googletest/include -std=c++2a -stdlib=libc++ test_suite_$v.cpp --gcc-toolchain=/lib/gcc9/9.2.0
  #done
  #clang++ -c -Igtest/googletest/googletest/include -std=c++2a -stdlib=libc++ $SUT/main.cpp --gcc-toolchain=/lib/gcc9/9.2.0
  #clang++ -Igtest/googletest/googletest/include -std=c++2a -stdlib=libc++ *.o --gcc-toolchain=/lib/gcc9/9.2.0 gtest/googletest/build/lib/libgtest.a -lpthread
#}
